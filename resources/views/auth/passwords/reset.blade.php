...
@section('content')
    ...
    <div class="text-white" id="password_change">
        ...
        <form method="POST" action="{{ route('password.update') }}" class="col-6 offset-3 shadow-lg pass_change">
            @csrf
            ...
            <div class="col-12">
                ...
                <div class="form-group row">
                    <button type="submit" class="btn bg-green m-4 badge-pill text-white">
                        {{ __('Підтвердити') }}
                    </button>
                </div>
            </div>
